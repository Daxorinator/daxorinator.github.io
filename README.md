...
- This project uses three [Eleventy Layouts](https://www.11ty.dev/docs/layouts/):
	...
	- `_includes/postslist.njk`   : A reuseable component that displays a list of all the posts
	- `_includes/projectslist.njk`: A reuseable component that displays a list of all my projects